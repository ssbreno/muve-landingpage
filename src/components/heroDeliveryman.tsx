    ...
    <div className="hero-blue-container relative overflow-hidden">
      ...
      <div className="hero-blue-div">
        ...
        <p className="p-blue mb-10">
          Especializada em same day delivery, desenvolve e executa estratégicas
          de transporte leve sobre duas e quatro rodas de forma a conectar
          negócios, entregadores e clientes finais com a máxima simplicidade,
