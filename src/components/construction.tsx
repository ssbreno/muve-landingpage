    ...
    <div className="relative min-h-screen flex flex-col justify-center items-center bg-hero bg-cover">
      ...
      <div className="relative justify-center items-center z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
        <div className="text-center space-y-10">
          ...
          <p className="text-xl lg:text-xl tracking-wide mx-8 lg:max-w-xl lg:mx-auto">
            Estamos construindo nossa página para melhores atendê-los, e
            continuar entregando qualidade em nossos serviços.
          </p>
        </div>
      </div>
      <div className="absolute bottom-5">
        <ul className="flex space-x-3">
          <li>
            <Link href="https://instagram.com/Muve.go">
          ...
          <li>
            <Link href="https://sistema.muve.delivery">
              <a className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
