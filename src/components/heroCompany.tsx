        ...
        <div className="bg-gray-0 px-4 flex flex-col justify-center text-gray-1000">
          <div className="sm:w-4/6 justify-center mx-auto gap-8">
            ...
            <p className="mb-[3.4rem] font-normal">
              Estudamos o seu caso e planejamos, criamos e gerenciamos todo o
              seu serviço de delivery (pessoal, tecnologia, operação e gestão)
              para que você se liberte da árdua missão de comandar as suas
              entregas.
            </p>
            <a
