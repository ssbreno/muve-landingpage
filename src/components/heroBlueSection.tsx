...
const BlueSection = () => {
  return (
    ...
    >
      <span className="absolute bg-gray-50 rounded-full h-24 w-24 top-[-1.5rem] left-[50%]"></span>
      <div className="md:w-[50%] flex flex-col mx-24 items-center justify-start">
        <div className="flex justify-center items-center flex-col">
          ...
          <div className="flex flex-col w-full ">
            <h2 className="font-poppins font-black  uppercase text-[2.2rem]">
              LOREM IPSUM DOLOR
            </h2>
      ...
      <div className="w-[50%] items-center flex flex-col items-center justify-center text-base">
        <p className="my-4">
          Lorem ipsum dolor sit amet. Sit cumque molestiae quo consequuntur
